...
class SegmentationTestConfig(base.BaseSegmentationConfig):
    """
    ...
    image_srcs: typing.Dict = {
        "random_5m": {
            "base_path": data_dir,
            "image_file_type": ".tif",
            "image_file_prefix": "segmentation",
            "image_file_postfix": "",
        }
    }
    ...
    def __init__(self) -> None:
        ...
        src.utils.data_utils.write_geotiff_to_file(
            3, 5000, 5000, areas.total_bounds, self.data_dir / "segmentation_img_sample.tif"  # , crs=project_crs
        )
        self.__doc__ = base.extend_docstring(self, base.BaseSegmentationConfig, base.BaseConfig)


def train_segmentation():
    config = SegmentationTestConfig()
...
def test_segmentation():
    ...
    save_dir = "unit_test/test_segmentation"
